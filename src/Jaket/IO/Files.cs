...
public static class Files
{
    ...
    public static void Append(string file, IEnumerable<string> lines) => File.AppendAllLinesAsync(file, lines).ContinueWith(_ => Events.Post(Events.InternalFlushFinish));
