...
3. Create lib folder in root directory.
   1. Copy **Assembly-CSharp.dll**, **Facepunch.Steamworks.Win64.dll**, **UnityEngine.UI.dll**, **UnityUIExtensions.dll** and **Unity.Addressables.dll** from `ULTRAKILL\ULTRAKILL_Data\Managed`
